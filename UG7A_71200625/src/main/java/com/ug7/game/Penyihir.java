...
public class Penyihir extends Karakter {
    ...
    public void buyWeapon(int weapon) {
        ...
        if (weapon != 2 && weapon != 3) { System.out.println("Sebagai penyihir kamu hanya boleh membeli tongkat/tongkat sihir!");}
    ...
    public void abilityAttack(Karakter karakter) {
        if (this.isAbilityReady) {
            int heal;
            if (this.isWalk()) { heal = karakter.getHP() / 2; } else { heal = 100; }
